...
from keras.layers import Dense, Bidirectional,ConvLSTM2D,Conv1D, Attention,TimeDistributed, Dropout, Reshape
...
plt.plot(series_test_y[:,40], label="validation set")
plt.plot(val_forecast[:,40], label="predicted")
plt.xlabel("Timestep")
plt.ylabel("Value")
plt.legend()
plt.show()
